...
public class MyAndroidAppActivityX extends Activity {

    private Spinner spinner1, spinner2, spinner3;
    private Button btnSubmit;
    //private DbAdapter_Tipo_Gasto dbAdapterTipoGasto ;
    private Cursor cursorTipoGasto ;
    private DbAdapter_Tipo_Gasto dbHelper;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.main);

        dbHelper = new DbAdapter_Tipo_Gasto(this);
        dbHelper.open();

        //Clean all data
        dbHelper.deleteAllTipoGastos();
        //Add some data
        dbHelper.insertSomeTipoGastos();
    ...
    public List < SpinnerObject> getAllLabels(){
        ...
        Cursor cursor = dbHelper.fetchAllTipoGastos();
    ...
    public void addListenerOnButton() {
        ...
        btnSubmit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MyAndroidAppActivityX.this,
                        "OnClickListener : " +
